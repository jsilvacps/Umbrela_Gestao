...
export async function POST(req: NextRequest) {
  try {
    ...
    const { nome, estabelecimento, whatsapp, assunto, mensagem } = body;
    ...
    const { error } = await resend.emails.send({
      ...
      to:       [DESTINATARIO],
      replyTo:  whatsapp ? undefined : undefined,
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
              ...
              <tr style="border-bottom: 1px solid #f3f4f6;">
                ...
                <td style="padding: 10px 0;">
                  ${whatsapp
                    ? `<a href="https://wa.me/55${whatsapp.replace(/\D/g, "")}" style="color: #16a34a; font-weight: 700;">${whatsapp}</a>`
                    : "—"
                  }
                </td>
              </tr>
